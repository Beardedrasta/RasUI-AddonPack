...
function Module:OnEnable()
  ...
  if (db) then
    ...
    AFKPanelTop.Text:SetPoint( "RIGHT", AFKPanelTop, "RIGHT", -25, 0 )
    AFKPanelTop.Text:SetFont( font, 40, "THICKOUTLINE" )
    ...
    AFKPanelTop.DateText:SetPoint( "LEFT", AFKPanelTop, "LEFT", 25, -65 )
    AFKPanelTop.DateText:SetFont( font, 15, "THICKOUTLINE" )

    AFKPanelTop.ClockText = AFKPanelTop:CreateFontString( nil, "OVERLAY" )
    AFKPanelTop.ClockText:SetPoint( "LEFT", AFKPanelTop, "LEFT", 25, -45 )
    AFKPanelTop.ClockText:SetFont( font, 20, "THICKOUTLINE" )
    ...
    AFKPanelTop.PlayerNameText:SetFont( font, 26, "THICKOUTLINE" )
    ...
    AFKPanel.Text:SetPoint("CENTER", AFKPanel, "LEFT", 140, -15 )
    AFKPanel.Text:SetFont( font, 100, "THICKOUTLINE" )
    AFKPanel.Text:SetText( "|cffff0000Ras|r|cffffcc00U|r|cFF32CD32I|r" )
    ...
    AFKPanel.playerModel:SetAnimation(52);
    ...
    AFKPanelTop.PlayerInfoText:SetPoint( "LEFT", AFKPanelTop, "LEFT", 25, -5 )
