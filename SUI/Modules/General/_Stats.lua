...
function Module:OnEnable()
  ...
  StatsFrame:SetPoint("TOP", UIParent, "TOP", 0, 0)
  ...
  if (db.display.fps or db.display.ms) then
    ...
    local function status()
      local function getFPS() return "|cFF32CD32" .. floor(GetFramerate()) .. "|r fps" end
      local function getLatency() return "|cFF32CD32" .. select(4, GetNetStats()) .. "|r ms" end
